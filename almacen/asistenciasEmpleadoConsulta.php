...
//include_once 'asistenciasEmpleado.php';
//$asistenciasEmpleado = new asistenciasEmpleado();
    ...
    <body>
      ...
      ?>
        ...
        <h3><center>Horas Realizadas </center></h3><!-- Título de módulo -->
          ...
          ?><a href="prestadoresConsulta.php" class="btn btn-default">< Regresar </a>  
             <!--Filtro avanzado-->
                  ...
                  <div id="collapse1" class="panel-collapse collapse">
                    ...
                    <form class="form-inline"  name="formulario" id="frmNewReq" action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
                            <div class="form-group">  
                                ...
                                <input type="number" class="form-control" id="codigo" name="codigo" placeholder="Código" value="" readonly>
                            </div> 
                            <div class="form-group">  
                                <label for="IdPrestacion"> IdPrestación</label>
                                <input type="number" class="form-control" id="IdPrestacion" name="IdPrestacion" placeholder="IdPrestacion" value=""  readonly>
                            </div> 
                        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="hidden" class="form-control" id="codigo" name="codigo" placeholder="Fecha" value="">
                        </div>
