...
<html lang="es">
    ...
    <body>
        <script>
            var fechPerPDF = <?php echo json_encode($obj->consultaFechaPermisoPDF()); ?>;
            var fechRepPDF = <?php echo json_encode($obj->consultaFechaReposicionPDF()); ?>;
            var perPDF = <?php echo json_encode($obj->consultaPermisoPDF()); ?>;
            
            var tabla = [];
            var tabla2 = [];
            
            for (i = 0; i < fechPerPDF.length; i++) {
                tabla.push([fechPerPDF[i][0], fechPerPDF[i][1]]);
            }
            
            for (i = 0; i < fechRepPDF.length; i++) {
                tabla2.push([fechRepPDF[i][0], fechRepPDF[i][1]]);
            }
            
            var prueba = {
    
                info: {
                    title:'Formato de Falta',
                ...
                content: [
                    ...
                    },
                    {
                        ...
                        "JUAN JOSÉ ARREOLA"\n\
                        \n\ FORMATO DE INCIDENCIAS Y FALTAS DE ASISTENCIA '+'\n\ ', style: 'header', alignment:'center'
                    },
                    {
                        style: 'tableExample',
                        table: {
                            widths: ['auto', '*'],
                            body: [
                                [{text: 'Folio:', bold: true}, perPDF[0]],
                                [{text: 'Nombre del solicitante:', bold: true}, perPDF[1]],
                                [{text: 'Jefe Inmediato:', bold: true}, perPDF[3]],
                                [{text: 'Fecha de solicitud:', bold: true}, perPDF[2]],
                                [{text: 'Motivo:', bold: true}, perPDF[4]],
                                [{text: 'Motivo Diferente:', bold: true}, perPDF[5]]
                            ]
                        }
                    },
                    {
                        ...
                        table: {
                            ...
                            body: [
                                ...
                                {border: [true, true, true, false], text: 'Fecha(s) de permiso.', style: 'tableHeader', alignment: 'center'}],
                            ]
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        table: {
                            ...
                            body: [
                                [{border: [true, true, true, false], text: 'Núm.', style: 'tableHeader', alignment: 'center'}, 
                                {border: [true, true, true, false], text: 'Fecha(s) de reposición.', style: 'tableHeader', alignment: 'center'}],
                            ]
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        table: {
                            widths: [115, '*'],
                            body: [
                                [{text: 'Observaciones:', bold: true}, perPDF[6]],
                                [{text: 'Estado:', bold: true}, perPDF[7]]
                            ]
                        }
                    },
                    {
                    },
                    {
                        ...
                        table: {
                            ...
                            body: [
                                ['\n\ \n\ \n\ ', '', ''],
                                [{text: 'Nombre y Firma del Solicitante', alignment: 'center'}, {text: 'Jefe Inmediato\n\(nombre y firma)', alignment: 'center'}, {text: 'CP. Y LAE. CARLOS PEÑA RAZO\n\Coordinador de Recursos Humanos', alignment: 'center'}]
                            ]
                        }
                    }
                ],
