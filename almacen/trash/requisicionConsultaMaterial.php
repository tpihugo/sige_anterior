            ...
            <div class="panel-group">
                <div class="panel panel-primary">
                  ...
                  <div class="form-group">
                       <label for="filtro1"><?php echo $obj ->getTitulo3(); ?>:</label>
                       <input type="date" class="form-control input-sm" name="filtro1" id="filtro1" placeholder="Buscar <?php echo $obj ->getTitulo3(); ?>">
                       </div>
                   <div class="form-group">
                        <label for="filtro2"><?php echo $obj ->getTitulo7(); ?>:</label>
                        <input type="text" class="form-control input-sm" name="filtro2" id="filtro2" placeholder="Buscar <?php echo $obj ->getTitulo7(); ?>">
                        </div>
                 </form></center>
                       <br>
