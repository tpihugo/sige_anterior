...
<html lang="es">
    <head>
        ...
        <script>
            var arregloDT = <?php echo json_encode($obj->muebleConsulta($_SESSION['idEmpleado'])); ?>;
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h3 style="text-align: center"><img src="../../sige/images/mueble.png"> Listado de Muebles por Resguardante</h3>
          </div>
             <!--tabla de consulta-->
