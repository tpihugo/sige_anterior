...
class horario {
    ...
    function consultaHorarios() {
        $pdo = new Conexion();
        $query = $pdo->prepare('SELECT idHorario, codigo, entradaLunVie, salidaLunVie, entradaSabDom, salidaSabDom, entradaVacaciones, '
                . 'salidaVacaciones, comentarios FROM HORARIO;');
        $query->execute();
