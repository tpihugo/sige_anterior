...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Listado de CT's. SIGE. BPEJ</title>
        ...
        <script>
            var arregloDT = <?php echo json_encode($ct->ctConsulta()); ?>;
            $(document).ready(function(){
                 var t = 'Listado de CTs';
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h3 style="text-align: center">Listado de CT's</h3>
          </div>
             <!--tabla de consulta-->
