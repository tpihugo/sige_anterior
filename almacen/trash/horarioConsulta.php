...
<html lang="es">
    <head>
        ...
        <script>
            var arregloDT = <?php echo json_encode($obj->consultaHorarios()); ?>;
            $(document).ready(function(){
                 var t = 'Listado de Horarios';
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header">
                <h3 style="text-align: center">Listado de Horarios</h3>
          </div>
             <!--tabla de consulta-->
            <div id="respuestaFiltro">
                <table id="dtPlantilla" class="display" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th>Código</th>
                            <th>Hora Entrada Lun-Vie</th>
                            <th>Hora Salida Lun-Vie</th>
                            <th>Hora Entrada Sab-Dom</th>
                            <th>Hora Salida Sab-Dom</th>
                            <th>Hora Entrada P. Vacacional</th>
                            <th>Hora Salida P. Vacacional</th>
                            <th>Comentarios</th>
                            <th>Movimiento</th>
                        </tr>
                    </thead>
