...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Totales de Mobiliario SIGE vs SIIAU. BPEJ</title>
        ...
        <script>
            var arregloDT = <?php echo json_encode($obj->muebleListadoTotales()); ?>;
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h3 style="text-align: center"><img src="../../sige/images/escritorio.png"> Listado de Totales de Muebles por Piso</h3>
          </div>
             <!--tabla de consulta-->
