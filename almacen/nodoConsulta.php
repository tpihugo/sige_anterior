...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Listado de Nodos. SIGE. BPEJ</title>
        ...
        <script>
            var arregloDT = <?php echo json_encode($nodo->nodoConsulta()); ?>;
            $(document).ready(function(){
                 var t = 'Listado de Nodos';
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h3 style="text-align: center">Listado de Nodos</h3>
          </div>
             <!--tabla de consulta-->
