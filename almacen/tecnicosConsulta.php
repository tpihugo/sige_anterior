...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Técnicos. CCD. SIGE. BPEJ</title>
        ...
        <script>
            var arregloDT = <?php echo json_encode($obj->tecnicoConsulta()); ?>;
            $(document).ready(function(){
                 var t = 'Listado de Técnicos';
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h3 style="text-align: center">Listado de Técnicos</h3>
          </div>
             <!--tabla de consulta-->
