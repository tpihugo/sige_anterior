...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="function/usuario.js"></script>
    </head>
    <body>
        <?php
                        ...
                        <center><form class="form-inline" id="filtros" method="POST">
                            ...
                            <div class="form-group">
                              <label for="filtro2"><?php echo $obj ->getTitulo3(); ?>:</label>
                                <input type="text" class="form-control input-sm"
                                       name="filtro2" id="filtro2" placeholder="Buscar <?php echo $obj ->getTitulo3(); ?>">
                            </div>
                            <div class="form-group">
                              <label for="filtro3"><?php echo $obj ->getTitulo4(); ?>:</label>
                                <input type="text" class="form-control input-sm"
                                       name="filtro3" id="filtro3" placeholder="Buscar <?php echo $obj ->getTitulo4(); ?>">
                            </div>
                            <div class="form-group">
