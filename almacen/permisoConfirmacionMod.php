...
<html lang="es">
    ...
    <body>
        ...
        if(isset($_POST['permisoModificar']))//Valida si se envía el formulario
        {
            include 'permiso.php';
            $obj = new permiso();
            
            $obj ->setIdPermiso($_POST['idPermiso']);
            ...
            $obj ->permisoModificar();
            $arregloPDF = $obj->consultaPermisoPorID();
            ?>
<script>
     var folio = '<?php echo $obj->getIdPermiso();?>';
      var empleado = '<?php print_r($arregloPDF[0]); ?>';
      var codigoUDG = '<?php print_r($arregloPDF[1]); ?>';
      var area = '<?php print_r($arregloPDF[2]); ?>';
      var fechaSolicitud = '<?php print_r($arregloPDF[3]); ?>';
      var fechaPermiso = '<?php print_r($arregloPDF[4]); ?>';
      var jefeInmediato = '<?php print_r($arregloPDF[5]); ?>';
      var motivo = '<?php print_r($arregloPDF[6]); ?>';
      var observaciones = '<?php print_r($arregloPDF[7]); ?>';
      var m1 = '';
      var m2 = '';
      var m3 = '';
      var m4 = '';
...
$(document).ready(function() {
    $('#btnAdd').click(function() {
        ...
        <div class="container">
            <br>
            <center><a href="permisoConsulta.php" class="btn btn-default">Volver a Consulta</a>
