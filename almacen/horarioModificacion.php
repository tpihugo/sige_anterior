                                ...
                                for ($i = 0; $i < 8; $i++){
                                    echo '
                                        <td>
                                            <div class="form-group">
                                                <div class="container-fluid">
                                                    <input class="form-control" id="entrada'.$i.'" type="time" value="'.$obj->getHoraEntrada().'" name="entrada'.$i.'">
                                                </div>
                                            </div>
                                        </td>
                                    ';
                                ...
                                for ($i = 0; $i < 8; $i++){
                                    echo '
                                        <td>
                                            <div class="form-group">
                                                <div class="container-fluid">
                                                    <input class="form-control" id="salida'.$i.'" type="time" value="'.$obj->getHoraSalida().'" name="salida'.$i.'">
                                                </div>
                                            </div>
                                        </td>
                                    ';
