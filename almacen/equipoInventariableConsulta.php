...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Equipos Inventariables. SIGE. BPEJ</title>
        ...
        <script>
            var arregloDT = <?php echo json_encode($equipo->equipoInventariableConsulta()); ?>;
            $(document).ready(function(){
                 var t = 'Listado de Equipos Inventariables';
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h3 style="text-align: center">Listado de Equipos Inventariables</h3>
          </div>
             <!--tabla de consulta-->
