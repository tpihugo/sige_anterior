...
<body>
    ...
    <div class="container">
        ...
        <form action="asistenciaSemanaBusqueda2.php" class="form-horizontal" id="busqueda" method="post">
            ...
            <input type="submit" class="btn btn-primary" id="buscarSemana" value="Buscar">
        </form>
        <div class="form-group">        
