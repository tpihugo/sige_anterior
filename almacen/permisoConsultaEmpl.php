...
<html lang="es">
    <head>
        ...
        <script>
            var arregloDT = <?php echo json_encode($obj->consultaPermisoPorEmpleado()); ?>;
        </script>
        <script type="text/javascript" src="function/permiso.js"></script>
    </head>
    <body>
        <?php
        ...
        $menu = new menu();
        $menu ->barraMenu();
//        print_r($obj->consultaPermiso());
        ?>
        
        <div class="container">
            <div class="page-header">
                <h3 style="text-align: center">Permisos Solicitados</h3>
          </div>
             <!--tabla de consulta-->
