    ...
    <body>
      ...
      <div class="container">
          <div class="page-header">
              <h3 style="text-align: center">Captura Periodo Vacacional</h3>
          </div>
          ...
          <form class="form-horizontal" action="aplicarMovimiento.php" method="post" onsubmit="return confirm('¿Seguro que quieres guardar este formulario?');">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="descripcionPeriodo" name="descripcionPeriodo" maxlength="50" autofocus required>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">          
                  <input type="date" class="form-control" id="finPeriodo" name="finPeriodo" required>
              </div>
            </div>
            <div class="form-group">        
              <div class="col-sm-offset-2 col-sm-10">
                <button type="submit" class="btn btn-primary" name="periodoVacacionalAlta">Guardar</button>
