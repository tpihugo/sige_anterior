...
<html lang="es">
    <head>
        ...
        <script>
            var arregloDT = <?php echo json_encode($pago->listaCargosPorPago()); ?>;
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h3 style="text-align: center"><?php echo $titulo;
                    echo "<br><br>";
                    echo "Detalle Cargos a Cuentas por Pago ".$pago->getIdPago();
