...
<body>
    ...
    <div class="container">
        <div class="page-header">
                <h3 style="text-align: center">Reporte Mensual por Personal</h3>
        </div>
        ...
        <form class="form-horizontal" id="busqueda"  method="post">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="month" class="form-control" name="mes" value="<?php echo date("Y-m");?>" id="mes" required="month">
              </div>
            </div>
            <div class="form-group">
        ...
        <div class="form-group">        
          <div class="col-sm-offset-2 col-sm-10">
            <input type="button" class="btn btn-primary" id="buscarMes" value="Buscar">
