    ...
    <body>
        ...
        <div class="container">
            <div class="page-header">
                <h3 style="text-align: center">Proyección de Compra de Material 2018 <small><?php echo $obj->getTipo(); ?></small></h3>
          </div>
            <!--Filtro avanzado-->
                ...
                <div class="panel panel-primary">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                        ...
                        <input type="number" class="form-control input-sm" name="filtro3" id="filtro3" placeholder="Buscar <?php echo $obj ->getTitulo4(); ?>">
                        </div>
                   <div class="form-group">
                   ...
                   <div class="form-group">
                       ...
                       <input type="number" class="form-control input-sm" name="filtro5" id="filtro5" placeholder="Buscar <?php echo $obj ->getTitulo6(); ?>">
                        </div> 
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="filtro7"><?php echo $obj ->getTitulo8(); ?>:</label>
                        <input type="text" class="form-control input-sm" name="filtro7" id="filtro7" placeholder="Buscar <?php echo $obj ->getTitulo8(); ?>">
                        </div>
                        <input type="hidden" name="filtro8" value="<?php echo $obj ->getTipo(); ?>">      
                 </form></center>
                       <br>
            ...
            <div id="respuestaFiltro">
                <table id="dtPlantilla" class="display" cellspacing="0" width="100%">
                    <thead>
                        <?php $obj->titulosMaterialProyeccion(); ?>
                    </thead>
                    <tfoot>
                        <?php $obj->titulosMaterialProyeccion(); ?>
                    </tfoot>
                    <tbody>
                        <?php $obj->consultaMaterialProyecciones(); ?>
                    </tbody>
                </table>
            </div>
             <!--tabla de consulta-->
