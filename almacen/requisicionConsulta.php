...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="function/requisicion.js"></script>
    </head>
    <body>
        <?php
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h3 style="text-align: center">Listado de Requisiciones <small><?php echo $obj->getTipo(); ?></small></h3>
          </div>
                        ...
                        <center><form class="form-inline" id="filtros" method="POST">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control input-sm"
                                       name="filtro1" id="filtro1" placeholder="Buscar <?php echo $obj ->getTitulo2(); ?>">
                            </div>
                            <div class="form-group">
                              <label for="filtro2"><?php echo $obj ->getTitulo3(); ?>:</label>
                              <input type="date" class="form-control input-sm"
                                       name="filtro2" id="filtro2">
                            </div>
                            <div class="form-group">
                              <label for="filtro4"><?php echo $obj ->getTitulo5(); ?>:</label>
                                <input type="text" class="form-control input-sm"
                                       name="filtro4" id="filtro4" placeholder="Buscar <?php echo $obj ->getTitulo5(); ?>">
                            </div>
                            <div class="form-group">
                              <label for="filtro5"><?php echo $obj ->getTitulo6(); ?>:</label>
                                <input type="text" class="form-control input-sm"
                                       name="filtro5" id="filtro5" placeholder="Buscar <?php echo $obj ->getTitulo6(); ?>">
                            </div>
                                <input type="hidden" name="filtro6" value="<?php echo $obj ->getTipo(); ?>">
                            </form></center>
                        <br>
