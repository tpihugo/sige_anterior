...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Totales de Mobiliario por Piso en SIGE. BPEJ</title>
        ...
        <script>
            var arregloDT = <?php echo json_encode($obj->muebleListadoTotalesSIGE()); ?>;
            $(document).ready(function(){
                 var t = 'Totales de Mobiliario por Piso';
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h3 style="text-align: center"><img src="../../sige/images/archivo.png"> Listado de Totales de Muebles por Piso</h3>
          </div>
             <!--tabla de consulta-->
