...
<html lang="es">
    <head>
        ...
        <script>
            var arregloDT = <?php echo json_encode($obj->consultaEntradaMaterial()); ?>;
        </script>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header">
                <h3 style="text-align: center">Detalle Entrega</h3>
          </div>
            ...
            <div id="respuestaFiltro">
             ...
             <!--tabla de consulta-->
             <a href="compraDetalle.php?id=<?php echo $obj->getIdCompra(); ?>&t=<?php echo $obj->getTipoCompra(); ?>" class="btn btn-default">Regresar</a>
