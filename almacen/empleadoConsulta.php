...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="function/empleado.js"></script>
    </head>
    <body>
        <?php
...
//        $_SESSION['movimiento']=$_GET['m'];
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h3 style="text-align: center">Listado de Personal</h3>
          </div>
            <!--Filtro avanzado-->
            <div class="panel-group">
                <div class="panel panel-primary">
                 ...
                 <div class="form-group">
                   ...
                   <div class="form-group">
                        <label for="filtro4"><?php echo $obj ->getTitulo8(); ?>:</label>
                        <input type="text" class="form-control input-sm" name="filtro4" id="filtro4" placeholder="Buscar <?php echo $obj ->getTitulo8(); ?>">
                        </div>
                   <div class="form-group">
                       <label for="filtro5"><?php echo $obj ->getTitulo9(); ?>:</label>
                       <input type="number" class="form-control input-sm" name="filtro5" id="filtro5" placeholder="Buscar <?php echo $obj ->getTitulo9(); ?>">
                        </div> 
                    <div class="form-group">
                        <label for="filtro6"><?php echo $obj ->getTitulo12(); ?>:</label>
                        <input type="number" class="form-control input-sm" name="filtro6" id="filtro6" placeholder="Buscar <?php echo $obj ->getTitulo12(); ?>">
                        </div>
                    <div class="form-group">
                        <label for="filtro7"><?php echo $obj ->getTitulo13(); ?>:</label>
                        <input type="text" class="form-control input-sm" name="filtro7" id="filtro7" placeholder="Buscar <?php echo $obj ->getTitulo13(); ?>">
                        </div>          
                 </form></center>
                       <br>
