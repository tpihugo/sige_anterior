            ...
            <table id="ciclos" class="table table-striped table-bordered" style="width:100%">
                ...
                @foreach($ciclos as $ciclo)
                    ...
                    @endif
                        ...
                        <td>{{$ciclo->leyenda}}</td>
                        <td>
                            <a href="{{route('edit-ciclo',$ciclo->id)}}" class="btn btn-primary">Modificar</a>
                            <a href="{{ route('eliminar-ciclo',$ciclo->id) }}" class="btn btn-primary">Eliminar</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
