...
<?php
 ...
 if ($_SESSION['privilegios'] != 'Administrador' and $_SESSION['privilegios'] != 'Sistemas' and $_SESSION['privilegios'] != 'Director') {
...
//        $_SESSION['movimiento']=$_GET['m'];
        ...
        <div class="container">
            <div class="page-header">
                <h3 style="text-align: center">Listado de &Aacute;reas</h3>
          </div>
            <!--Filtro avanzado-->
