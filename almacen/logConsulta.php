...
<html lang="es">
    <head>
        ...
        <script>
            var arregloDT = <?php echo json_encode($log->logConsulta()); ?>;
            $(document).ready(function(){
                 var t = 'Listado de Registros (Log)';
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h3 style="text-align: center">Listado de Registros (Log)</h3>
          </div>
             <!--tabla de consulta-->
