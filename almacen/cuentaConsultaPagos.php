...
include 'pago.php';
$pago = new pago();
if (isset($_GET['cuenta']) && $_GET['cuenta']!='') { 
    $pago ->setIdCuenta($_GET['cuenta']);
...
<html lang="es">
    <head>
        ...
        <script>
            var arregloDT = <?php echo json_encode($pago->cuentaConsultaPagos()); ?>;
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h3 style="text-align: center"><?php echo $titulo; 
                    ...
                    echo "Listado de Pagos por Cuenta "
