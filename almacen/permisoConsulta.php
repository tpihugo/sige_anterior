...
<html lang="es">
    <head>
        ...
        <script>
            var arregloDT = <?php echo json_encode($obj->permisoConsulta()); ?>;
            $(document).ready(function(){
                 var t = 'Listado de Incidencias y Faltas de Asistencia';
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h3 style="text-align: center">Listado de Incidencias y Faltas de Asistencia</h3>
          </div>
            <!--tabla de consulta-->
                ...
                <table id="dtPlantilla" class="display" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th>Motivo</th>
                            <th>Motivo Diferente</th>
                            <th>Observaciones</th>
                            <th>Estatus</th>
                            <?php
                            if($_SESSION['privilegios'] == 'Administrador' or $_SESSION['privilegios'] == 'RH-Almacen'  or $_SESSION['privilegios'] == 'Recursos Humanos'){
                                echo "<th>Acción</th>";
