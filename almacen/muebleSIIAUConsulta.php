...
include 'muebleSIIAU.php';
$muebleSIIAU = new muebleSIIAU();

?>
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Mobiliario SIIAU. SIGE. BPEJ</title>
        ...
        <script>
            var arregloDT = <?php echo json_encode($muebleSIIAU->muebleSIIAUConsulta()); ?>;
            $(document).ready(function(){
                 var t = 'Listado de Mobiliario en SIIAU';
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h3 style="text-align: center">Listado en SIIAU de  Mobiliario</h3>
          </div>
             <!--tabla de consulta-->
