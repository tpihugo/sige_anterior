...
<html lang="es">
    <head>
        ...
        <script>
            var arregloDT = <?php echo json_encode($obj->consultaFiltro($_SESSION['idEmpleado'])); ?>;
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h3 style="text-align: center"><img src="../../sige/images/ordenador.png"> Listado de Equipos</h3>
          </div>
             <!--tabla de consulta-->
                ...
                <table id="dtPlantilla" class="display" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th>Tipo Conexión</th>
                            <th>Detalles</th>
                            <?php if($_SESSION['privilegios'] == 'Administrador' or $_SESSION['privilegios'] == 'Sistemas') {
                             echo '<th>Inventario</th>';}else{ echo '<th></th>';}
                             ?>
                            <th>MAC</th>
                            
                            <?php 
                             if($_SESSION['privilegios'] == 'Administrador' or $_SESSION['privilegios'] == 'Direccion') {echo '<th>Factura</th>';} 
                             if($_SESSION['privilegios'] == 'Administrador' or $_SESSION['privilegios'] == 'Sistemas') {echo '<th>Modificar</th>';}
                             //if($_SESSION['privilegios'] == 'Administrador' or $_SESSION['privilegios'] == 'Sistemas') {echo '<th>Modificar Resguardante</th>';}?>   
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
