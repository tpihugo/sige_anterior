...
<html lang="es">
    <head>
        ...
        <script>
            var arregloDT = <?php echo json_encode($obj->movimientoConsulta()); ?>;
            $(document).ready(function(){
                 var t = 'Listado de Movimientos';
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h3 style="text-align: center">Listado de Movimientos (Apertura, Cargos y Abonos)</h3>
          </div>
             <!--tabla de consulta-->
